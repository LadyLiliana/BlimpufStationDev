...
book-text-mars-incident = By the year 2100, with the immense nearly limitless funding of the Trans-Solar Federation and the technological marvels provided by NanoTrasen and Cybersun, the first permanent Mars Colonies were established.
        These colonies focus was primarily the mining and processing of Plasma. Condensers were created that could store the Plasma in a gaseous state, which allowed them to be stored at incredibly high pressures to minimize space needed for transport back to Terra.
        ...
        In truth, these engines leveraged a previously unknown phenomenon known as Bluespace, and did not violate the laws of physics as some scientists initially feared. Bluespace was more compact, and when charted precisely, could be used to vastly shorten the duration of space travel.
        ...
        Over the next year, this debris drifted into Terra's orbit, with multiple impacts devastating historical sites on the Moon, and more tragically making landfall on Terra itself.
        These meteor showers caused massive devastation nnumerous territories, resulting in untold tens of thousands of deaths.
